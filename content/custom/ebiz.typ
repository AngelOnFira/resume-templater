#let content = (
  ...
  experience: (
    (
      ...
      description: (
        ...
        "Managed *microservice* lifecycles within *Kubernetes*, and scaled AWS resources to meet service demand",
    ...
    (
      ...
      full: "",
      description: (
        "Developed *Godot & Unity C#* plugins for Rivet API integration, onboarding docs, and runnable examples",
        ...
        "Implemented server log retrieval with *Vector* pipelines, *ClickHouse* storage, and live streaming *RESTful APIs*",
        "Responded on-call to infrastructure downtime and incident remediation across production clusters",
    ...
    (
      ...
      description: (
        ...
        // "Maintained and upgraded legacy *Django* codebase using *OOP* and *MVC* patterns, designing *RESTful APIs* and *PostgreSQL* schema migrations to support new features",
        // "Architected and implemented a new *Rust* backend service to address emerging customer needs",
    ...
    (
      ...
      description: (
        "Re-designed *Gitlab CI/CD* pipeline to use *Docker* images and optimize *Rust* builds",
    ...
    (
      ...
      description: (
        "Led backend development in *Django* with *MySQL*, supporting feature evolution across 4 public-sector clients",
        "Built *CI/CD* pipelines (*Jenkins, GitHub Actions*) automating *unit testing* and production deployments",
  ...
  skills: (
    (
      ...
      items: (
        (
          content: "Rust • Python • C# • JavaScript • TypeScript",
    ...
    (
      ...
      items: (
        (
          content: "PostgreSQL • MySQL • MongoDB • ClickHouse • Redis",
          tags: ("backend", "architecture"),
        ),
      ),
    ),
